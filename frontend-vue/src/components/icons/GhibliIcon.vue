...
const props = defineProps({
  ...
  color: { type: String, default: "#f2a0a0" }, // Used for heart and potentially others
});
</script>

<template>
  <div class="ghibli-icon" :style="{ width: size + 'px', height: size + 'px' }">
    <!-- Heart -->
    <svg
      v-if="type === 'heart'"
      viewBox="0 0 20 20"
    ...
    <!-- Mini Soot -->
    <svg
      v-else-if="type === 'soot' || type === 'miniSoot'"
      viewBox="0 0 20 20"
      :width="size"
      :height="size"
      xmlns="http://www.w3.org/2000/svg"
    ...
    <!-- Mini Calcifer -->
    <svg
      v-else-if="type === 'calcifer' || type === 'miniCalcifer'"
      viewBox="0 0 20 20"
      :width="size"
      :height="size"
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="M6 14 Q4 6 8 3 Q9 1 10 0 Q11 1 12 3 Q16 6 14 14Z" fill="#f47a30" />
      <path d="M8 14 Q7 9 9 5 Q10 3 10 3 Q10 3 11 5 Q13 9 12 14Z" fill="#f9b030" />
    ...
    <!-- Mini Totoro -->
    <svg
      v-else-if="type === 'totoro' || type === 'miniTotoro'"
      viewBox="0 0 20 24"
      :width="size"
      :height="size"
      xmlns="http://www.w3.org/2000/svg"
    >
      <line
        ...
        stroke-linecap="round"
      />
      <ellipse cx="10" cy="0" rx="1.5" ry="2.5" fill="#6aaa4a" transform="rotate(-15 10 0)" />
      <ellipse cx="5.5" cy="5" rx="2.5" ry="3.5" fill="#858880" transform="rotate(-15 5.5 5)" />
      <ellipse cx="14.5" cy="5" rx="2.5" ry="3.5" fill="#858880" transform="rotate(15 14.5 5)" />
    ...
    <!-- Mini Gift (Wishlist) -->
    <svg
      v-else-if="type === 'gift' || type === 'wishlist'"
      viewBox="0 0 20 20"
      :width="size"
      :height="size"
      xmlns="http://www.w3.org/2000/svg"
    ...
    <!-- Mini Book -->
    <svg
      v-else-if="type === 'book' || type === 'books'"
      viewBox="0 0 20 20"
      :width="size"
      :height="size"
      xmlns="http://www.w3.org/2000/svg"
    >
      ...
      <line x1="10" y1="5" x2="10" y2="16" stroke="#5a9aaa" stroke-width="0.5" />
      <line x1="4.5" y1="8" x2="8.5" y2="7.5" stroke="#fff" stroke-width="0.6" opacity="0.5" />
      <line x1="4.5" y1="10" x2="8.5" y2="9.5" stroke="#fff" stroke-width="0.6" opacity="0.5" />
      <line x1="4.5" y1="12" x2="8.5" y2="11.5" stroke="#fff" stroke-width="0.6" opacity="0.5" />
      <line x1="11.5" y1="7.5" x2="15.5" y2="8" stroke="#fff" stroke-width="0.6" opacity="0.5" />
      <line x1="11.5" y1="9.5" x2="15.5" y2="10" stroke="#fff" stroke-width="0.6" opacity="0.5" />
      <line x1="11.5" y1="11.5" x2="15.5" y2="12" stroke="#fff" stroke-width="0.6" opacity="0.5" />
      <path d="M10 4 L8 3 Q6 2.5 4 3" stroke="#d4a060" stroke-width="0.6" fill="none" />
    </svg>

    <!-- Mini Film (Movies) -->
    <svg
      v-else-if="type === 'film' || type === 'movies'"
      viewBox="0 0 20 20"
      :width="size"
      :height="size"
      xmlns="http://www.w3.org/2000/svg"
    >
      ...
      />
      <line x1="5" y1="3.5" x2="6.5" y2="7" stroke="#f9e27a" stroke-width="0.8" />
      <line x1="9" y1="3" x2="10.5" y2="6.8" stroke="#f9e27a" stroke-width="0.8" />
      <line x1="13" y1="3" x2="14.5" y2="6.8" stroke="#f9e27a" stroke-width="0.8" />
      <circle cx="7" cy="13" r="2" fill="none" stroke="#f9e27a" stroke-width="0.8" />
      <circle cx="7" cy="13" r="0.6" fill="#f9e27a" />
      <circle cx="13" cy="13" r="2" fill="none" stroke="#f9e27a" stroke-width="0.8" />
      <circle cx="13" cy="13" r="0.6" fill="#f9e27a" />
    </svg>

    <!-- Mini Pin (Places) -->
    <svg
      v-else-if="type === 'pin' || type === 'places'"
      viewBox="0 0 20 20"
      :width="size"
      :height="size"
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="M10 18 Q4 12 4 8 Q4 3 10 2 Q16 3 16 8 Q16 12 10 18Z" fill="#f47a60" />
    ...
    <!-- Mini Leaf (Habits) -->
    <svg
      v-else-if="type === 'leaf' || type === 'habits'"
      viewBox="0 0 20 20"
      :width="size"
      :height="size"
      xmlns="http://www.w3.org/2000/svg"
    >
      ...
      <path d="M10 10 Q6.5 6 5 5" stroke="#6a9b6a" stroke-width="0.5" fill="none" />
      <path d="M10 8 Q13 5 14 4" stroke="#8ab88a" stroke-width="0.5" fill="none" />
    ...
    <!-- Mini Sparkle -->
    <svg
      v-else-if="type === 'sparkle' || type === 'other'"
      viewBox="0 0 20 20"
      :width="size"
      :height="size"
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="M10 2 L11 8 L17 10 L11 12 L10 18 L9 12 L3 10 L9 8Z" fill="#f9e27a" />
      ...
      <path d="M10 2 L11 8 L17 10 L11 12 L10 18 L9 12 L3 10 L9 8Z" fill="#f9e27a" opacity="0.3">
        <animateTransform
    ...
    >
      ...
      <path d="M10 4 Q8 2 7 3 Q6 4 7 5 Q8 6 10 8 Q12 6 13 5 Q14 4 13 3 Q12 2 10 4Z" fill="#f2a0a0">
